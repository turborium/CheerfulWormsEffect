  ...
  procedure Draw();
    ...
    begin
      ...
      begin
        ...
        Pixel.R := Min(255, Pixel.R + ParticleGlowRValue);
        Pixel.G := Min(255, Pixel.G + ParticleGlowGValue);
        Pixel.B := Min(255, Pixel.B + ParticleGlowBValue);
        ...
        Pixel.R := Min(255, Pixel.R + ParticleRValue);
        Pixel.G := Min(255, Pixel.G + ParticleGValue);
        Pixel.B := Min(255, Pixel.B + ParticleBValue);
